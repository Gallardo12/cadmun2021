        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <p class="pt-5 mb-5 text-center">
                    ...
                    <a href="PDFs\11_FWL_BACKGROUND_PAPER.pdf" target="_blank" class="btn btn-primary p-3">Background Paper</a>
                </p>
            </div>
        </div>
    </div>
...
<section class="section">
    <div class="container element-animate">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-5 text-center">
                <div class="">
                    <div class="frame"><img src="images/Comites/11_FWL/11_Moderator_ValeriaEspinosa.JPG" alt="Moderator"
                            class="w-100 img-thumbnail"></div>
                </div>
            </div>
        </div>
